  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={city.customMetaDescription || city.customHeroSubhead || `Local auto insurance agency serving ${city.city}, ${city.state}. Auto, home, renters, condo, and life insurance with personalized service. Serving ${city.zipCodes.length > 1 ? 'ZIP codes' : 'ZIP code'} ${city.zipCodes.join(', ')}.`}
        />
        ...
        <meta property="og:description" content={city.customMetaDescription || city.customHeroSubhead || `Local auto insurance agency serving ${city.city}, ${city.state}. Auto, home, renters, condo, and life insurance with personalized service.`} />
      ...
      {/* H2: [City] Condo Insurance - Foley-style */}
      {city.condoInsuranceH2 && (
        <section className="py-16 px-4 bg-muted/30">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
              {city.city} Condo Insurance
            </h2>
            <article className="prose prose-lg max-w-none">
              {renderProseParagraphs(city.condoInsuranceH2)}
            </article>
          </div>
        </section>
      )}
      ...
      {/* H2: [City] Life Insurance - Huntsville-style */}
      {city.lifeInsuranceH2 && (
        <section className="py-16 px-4 bg-muted/30">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
              {city.city} Life Insurance
            </h2>
            <article className="prose prose-lg max-w-none">
              {renderProseParagraphs(city.lifeInsuranceH2)}
            </article>
          </div>
        </section>
      )}
      ...
      {/* H2: Bundle Home and Auto Insurance in [City], [State] */}
      {city.bundleH2 && (
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
              Bundle Home and Auto Insurance in {city.city}, {city.stateAbbr}
            </h2>
            <article className="prose prose-lg max-w-none">
              {renderProseParagraphs(city.bundleH2)}
            </article>
          </div>
        </section>
      )}
