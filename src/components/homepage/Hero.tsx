...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* Centered Floating Navy Card */}
      <div className="relative z-10 container-custom py-16">
        <div className="bg-primary rounded-2xl shadow-2xl max-w-3xl mx-auto p-10 md:p-16 space-y-8">
          {/* Trust Indicators */}
          ...
          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-white/90 text-balance text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-8 text-sm text-white/90 justify-center">
