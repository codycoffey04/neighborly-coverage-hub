    ...
    >
      ...
      <div className="relative z-10 container-custom pt-8 pb-0">
        <div className="max-w-4xl mx-auto space-y-5 animate-fade-in"
          ...
          {/* Main Headline */}
          <h1 className="text-balance text-center text-white font-[800] tracking-tight text-[clamp(2.2rem,5vw,3.5rem)] drop-shadow-lg" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.25)' }}>Your Local Auto Insurance Agency in Centre, AL & Rome, GA</h1>
