  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Condo insurance (HO-6) quotes in Alabama & Georgia. Protect your unit, personal property & liability. Walls-in coverage, loss assessment, master policy coordination. 4.8★ Google rating." 
        />
